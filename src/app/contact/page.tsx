          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-5 backdrop-blur-xl">
                ...
                <a href={`mailto:${COMPANY_INFO.contact.email}`} className="text-sm font-bold text-white hover:text-emerald-400 transition block mt-0.5">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-white/10 bg-slate-900 px-4 py-2.5 text-xs text-white placeholder-slate-600 focus:border-emerald-400 focus:outline-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-white/10 bg-slate-900 px-4 py-2.5 text-xs text-white focus:border-emerald-400 focus:outline-none"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl border border-white/10 bg-slate-900 px-4 py-2.5 text-xs text-white placeholder-slate-600 focus:border-emerald-400 focus:outline-none resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 py-3 text-xs font-bold text-white shadow-lg hover:from-emerald-400 hover:to-teal-500 transition"
                  >
            ...
            {COMPANY_INFO.offices.map((office, idx) => (
              <GlowCard key={idx} className="p-6">
                <div className="flex items-center justify-between pb-3 border-b border-white/10">
                  ...
                  <span className="text-[10px] font-mono font-bold rounded bg-slate-800 px-2.5 py-0.5 text-emerald-400">
                    {office.badge}
                  </span>
                </div>
