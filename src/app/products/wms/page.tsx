    ...
    <div className="space-y-24 sm:space-y-32 pb-24">
      ...
      <section className="relative pt-12 pb-16 text-center">
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/demo"
              className="hover-shine inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 px-8 py-3.5 text-xs font-extrabold text-white shadow-lg shadow-emerald-500/25 hover:from-emerald-400 hover:to-teal-500 transition"
            >
      ...
      <AnimatedSection className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="rounded-3xl border border-emerald-500/30 bg-emerald-950/20 p-8 backdrop-blur-xl shadow-2xl">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {product.detailedContent.workflowSteps.map((ws, i) => (
            <div key={i} className="rounded-2xl border border-white/10 bg-slate-900/40 p-6 relative">
              <div className="font-mono text-3xl font-extrabold text-emerald-400/40">
                {ws.step}
              </div>
