  ...
  return (
    <div className="space-y-24 sm:space-y-32 pb-24">
      ...
      <section className="relative pt-12 pb-16 text-center">
        <div className="pointer-events-none absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[450px] w-[700px] rounded-full bg-sky-500/15 blur-3xl" />
      ...
      <AnimatedSection className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-300/10 bg-slate-950/80 p-8 sm:p-12 backdrop-blur-xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 rounded-2xl border border-sky-500/30 bg-sky-950/20 p-6 text-center space-y-4">
          ...
          {COMPANY_INFO.offices.map((office, idx) => (
            <GlowCard key={idx} className="p-6">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-mono font-bold uppercase rounded bg-slate-800 px-2 py-0.5 text-sky-400">
                  {office.badge}
                </span>
